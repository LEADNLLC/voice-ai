...
<section class="hero">
<h1>Never Miss<br>Another Call.</h1>
<p class="hero-sub">Your presence. When you can't be there.</p>
...
<div class="hero-demo-note">No signup required • Hear it for yourself</div>
</div>
...
<h2 class="section-title">What happens when<br>you're always there.</h2>
<div class="features-grid">
<div class="feature">
<div class="feature-icon">📞</div>
<h3>Every Call Answered</h3>
<p>Someone picks up. Every time. No voicemail. No "leave a message." Just a real conversation when they need you.</p>
</div>
<div class="feature">
<div class="feature-icon">🤝</div>
<h3>Follow Through</h3>
<p>The second call. The third. The one that closes. Showing up until the job is done.</p>
</div>
<div class="feature">
<div class="feature-icon">🔒</div>
<h3>Nothing Slips</h3>
<p>Every lead you paid for. Every opportunity you earned. Handled like you would handle it yourself.</p>
</div>
</div>
</section>
...
<div class="section-label">Works For</div>
<h2 class="section-title">Any Business.<br>Any Call.</h2>
<p style="color:var(--gray-400);max-width:600px;margin:0 auto">Whatever you do. Whoever calls. They get the same experience every time.</p>
...
<h2 class="section-title">Hear it for yourself</h2>
<p class="demo-sub">Enter your phone number, pick your industry, and receive a call in 10 seconds. No signup required.</p>
...
<div class="section-label">🛠️ Custom Setup</div>
<h2 class="section-title">Build Your Own Voice</h2>
<p class="creator-sub">Don't see your industry? Create a custom voice in seconds. Same natural conversation, tailored to your business.</p>

<div class="creator-box">
<div class="creator-tabs">
<button class="creator-tab active" id="creator-tab-outbound" onclick="switchCreatorTab('outbound')">📤 Outbound Sales</button>
<button class="creator-tab" id="creator-tab-inbound" onclick="switchCreatorTab('inbound')">📥 Inbound Reception</button>
</div>
...
<div class="review-text">"We went from booking 8 appointments a week to 47. Customers don't even know they're not talking to our team. This completely transformed our roofing business."</div>
...
<div class="review-card">
<div class="review-stars">★★★★★</div>
<div class="review-text">"I was skeptical at first, but VOICE paid for itself in the first week. Our show rate went from 40% to 78% because every appointment gets confirmed perfectly."</div>
<div class="review-author">
...
<div class="review-card">
<div class="review-stars">★★★★★</div>
<div class="review-text">"VOICE handles 200+ calls a day for our dental practice. Patients love 'Emily' and we've cut our front desk costs by 60%."</div>
<div class="review-author">
...
<div class="review-card">
<div class="review-stars">★★★★★</div>
<div class="review-text">"The custom feature is incredible. We set up VOICE for our pool cleaning service in 5 minutes and it books 30+ appointments weekly."</div>
<div class="review-author">
...
<div class="pricing-headline">Custom Solutions That Scale</div>
...
<div class="pricing-feature-item">Unlimited Voices</div>
<div class="pricing-feature-item">Unlimited Calls</div>
<div class="pricing-feature-item">Custom Scripts</div>
...
<a href="#" onclick="openBookingModal(); return false;" class="pricing-cta-btn">📞 Let's Talk</a>
<p class="pricing-note">Free demo included • No commitment • Setup in 24 hours</p>
</div>
</div>
</section>
...
<a href="#features">The Difference</a>
...
<div class="trial-sub">Get full access to all features for 7 days</div>
