...
function renderComplianceCard(lead) {
    const steps = [
        { key: 'fb_submitted', label: '📥 Facebook Lead Submitted', time: lead.created_at },
        { key: 'text_sent', label: '💬 Welcome Text Sent', time: lead.text_sent_at },
        { key: 'call_1', label: '📞 First Call', time: lead.call_1_at },
        { key: 'call_2', label: '📞 Second Call (if no answer)', time: lead.call_2_at },
...
<button class="btn btn-primary" onclick="loadCompliance()">🔄 Refresh</button></div>
