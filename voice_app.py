...
def make_call(phone, name="there", agent_type="roofing", is_test=False, use_spanish=False, ghl_contact_id=None, address="", text_first=None):
    ...
    if is_inbound:
        ...
        # 🔥 v3 OPENING: Reference text + Lead with bill guess
        if address:
            opening = f"Hey {name} - Hailey here. Did you see that text I just sent about {address}? So let me guess - you're paying way over $200 a month just like everyone else out here, right?"
        else:
            opening = f"Hey {name} - Hailey here. Did you see that text I just sent? So let me guess - you're paying way over $200 a month on your electric bill just like everyone else out here, right?"
