...
function updateAriaCopilot(convo) {
    ...
    if (convo.intent === 'objection' || hasSpouseMention) {
        ...
        insight = 'They mentioned needing to discuss with someone else. <strong>Do not push.</strong> Use permission-based questions and offer to send info they can review together.';
        suggestedReplies = [
        ...
        insight = 'Asking about pricing. <strong>Focus on value first.</strong> Understand their needs before discussing numbers. This qualifies their interest!';
        suggestedReplies = [
            { text: 'Great question! To give you accurate pricing, can I ask what you are hoping to accomplish?', type: 'Discovery', style: 'nepq' },
        ...
        insight = 'This lead is <strong>ready to move forward!</strong> Book them immediately. Do not let this opportunity cool down.';
        suggestedReplies = [
            { text: 'Awesome! Lets get you scheduled. Does tomorrow at 10am or 2pm work better?', type: 'Booking', style: 'direct' },
        ...
        insight = 'Been a while since they responded. Send a <strong>gentle, no-pressure</strong> message. They might just be busy!';
        suggestedReplies = [
            { text: 'Hey ' + name + '! Just checking in — no pressure at all. Here whenever you are ready! 🙂', type: 'Soft', style: 'soft' },
        ...
        insight = 'Asking about scheduling/timing. Great sign! <strong>Be flexible</strong> and offer specific times.';
        suggestedReplies = [
            { text: MESSAGE_TEMPLATES.timing.replace('{name}', name), type: 'Flexible', style: 'soft' },
            { text: 'Pretty flexible! What time works best with your schedule?', type: 'Accommodating', style: 'nepq' },
        ...
        suggestedReplies = [
            { text: 'No problem at all! Feel free to reach out if anything changes. Have a great day!', type: 'Graceful Exit', style: 'soft' },
            { text: 'Totally understand! Is there anything specific that did not work for you? Just want to make sure I am not missing something.', type: 'Feedback', style: 'nepq' }
        ];
    } else {
        analysisIcon = '💬';
        ...
        suggestedReplies = [
            { text: 'Really helpful to know! What would be the ideal outcome for you?', type: 'Discovery', style: 'nepq' },
            { text: 'Thanks for sharing! Can I ask what prompted you to reach out today?', type: 'Qualifying', style: 'soft' },
            { text: 'Interesting! Tell me more about what you are looking for.', type: 'Open-ended', style: 'direct' }
        ];
    }
