...
RETELL_PHONE_NUMBER = os.environ.get('RETELL_PHONE_NUMBER', '+18562635703')
...
def make_call(phone, name="there", agent_type="roofing", is_test=False, use_spanish=False, ghl_contact_id=None, address=""):
    ...
    if is_inbound:
        ...
        from_number = '+18083005141'  # SMS number (Hawaii - for texts only)
        call_type = "outbound"
        ...
        from_number = RETELL_PHONE_NUMBER  # +18562635703 (Camden NJ)
        call_type = "outbound"
        call_purpose = "appointment_setting"
        greeting_style = "sales"
