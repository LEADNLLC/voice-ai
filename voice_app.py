...
import base64
import pytz  # For Pacific timezone handling
...
RETELL_PHONE_NUMBER = os.environ.get('RETELL_PHONE_NUMBER', '+17252523878')  # Las Vegas NV - Retell (default)
...
RETELL_PHONE_POOL = {
    ...
    '702': '+17252523878',  # Las Vegas NV
    '725': '+17252523878',  # Las Vegas NV
    '775': '+17252523878',  # Reno NV (fallback to Vegas)
...
RETELL_STATE_FALLBACK = {
    'NV': '+17252523878',  # Nevada → Las Vegas
...
RETELL_DEFAULT_NUMBER = os.environ.get('RETELL_PHONE_NUMBER', '+17252523878')
