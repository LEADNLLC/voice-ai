...
RETELL_PHONE_NUMBER = os.environ.get('RETELL_PHONE_NUMBER', '+17252523878')  # Las Vegas NV - Retell
...
def make_call(phone, name="there", agent_type="roofing", is_test=False, use_spanish=False, ghl_contact_id=None, address=""):
    ...
    if is_inbound:
        ...
        from_number = RETELL_PHONE_NUMBER  # +17252523878 (Las Vegas NV - Retell)
        call_type = "outbound"
        ...
        from_number = RETELL_PHONE_NUMBER  # +17252523878 (Las Vegas NV)
        call_type = "outbound"
        call_purpose = "appointment_setting"
        greeting_style = "sales"
...
<script>setTimeout(()=>location.reload(),60000)</script>
            ...
            try:
                ...
                outbound_number = RETELL_PHONE_NUMBER  # +17252523878 (Las Vegas NV)
