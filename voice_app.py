    ...
    try:
        ...
        if appt_date and appt_time:
            try:
                ...
                # Format for GHL API (Hawaii time)
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == '/':
            ...
            # Show current security status and blocked IPs
            self.send_json({
            ...
            self.send_json({'success': True, 'message': 'Security blocks cleared'})
...
<header>
    <div>
        <h1>Analytics</h1>
        <div class="time">{hawaii_time} Hawaii</div>
    </div>
    <nav>
