...
let html='';
for(let i=0;i<firstDay;i++){const d=new Date(y,m,1-firstDay+i);html+='<div class="cal-day-cell other-month" onclick="selectCalDay(\\''+d.toISOString().split('T')[0]+'\\')"><div class="cal-day-num">'+d.getDate()+'</div></div>'}
